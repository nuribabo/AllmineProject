					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							<a class="dropdown-item" href="./itemView_controller">전체 상품</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="VF"%>">과일·채소류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="SF"%>">해·수산물류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="MP"%>">정육·알·육가공품류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="SC"%>">향신료·양념류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="RS"%>">가공·간편식류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="GD"%>">곡물·견과류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="MI"%>">유제품류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="SS"%>">면·가루·유지류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="FO"%>">반찬류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="DR"%>">음료·주류</a> <a
								class="dropdown-item" href="./itemView_controller?name=<%="NA"%>">자연산물</a>
						</div></li>
