...
<html lang="en">
  ...
  <%
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="main.jsp">2차프로젝틐ㅋ</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <a class="nav-link dropdown-toggle" href="shop.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">전체상품</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="./itemView_controller">전체 상품</a>
              	<a class="dropdown-item" href="wishlist.html">전체상품</a>
                <a class="dropdown-item" href="product-single.html">과일</a>
                <a class="dropdown-item" href="cart.html">채소</a>
                <a class="dropdown-item" href="checkout.html">정육</a>
              </div>
            </li>
...
<div class="col-md pr-4 d-flex topper align-items-center ">
						    ...
						    <%}%></li>
						    <ul class="dan1">
						   <li><div><form action = "searchWord_controller"><input name="sword" type="text" id="" value="" required="required" label="검색어" class="inp_search" >
						   <input  type="button" src="https://res.kurly.com/pc/service/common/1908/ico_search_x2.png" class="btn_search" ></form></div></li></ul>
						   </ul>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"><%=itemlist.get(i).getPrice() %></span>
		    						<span class="price-sale">할인가격</span></p>
		    					</div>
	    					</div>
